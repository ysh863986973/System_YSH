...
<form action="user?method=updateThePass" method="post">
    <table width="1000px" align="center" border="1px">
        ...
        <tr>
            <td>账号：</td>
            <td>
                <input type="text" name="userName" value="${modifyThePass[0].name}" readonly>
            </td>
        </tr>
        ...
        <tr>
            <td>姓名：</td>
            <td><input type="text" name="name" value="${modifyThePass[0].name}"></td>
        </tr>

        <tr>
            <td>年龄：</td>
            <td>
                <input type="text" name="age" value="${modifyThePass[0].age}">
            </td>
        </tr>
        <tr>
            <td>性别</td>
            <td>
                <c:choose>
                    <c:when test="${!modifyThePass[0].gender}">
        ...
        <tr>
            <td>身份证号：</td>
            <td>
                <input type="text" name="IDNumber" value="${modifyThePass[0].IDNumber}">
            </td>
        </tr>
        <tr>
            <td>基本工资：</td>
        ...
        <tr>
            <td>部门：</td>
            <td>
                <input type="text" name="department" value="${modifyThePass[0].department}">
            </td>
        </tr>
        <tr>
            <td>职位：</td>
            <td>
                <input type="text" name="job" value="${modifyThePass[0].job}">
            </td>
        </tr>
